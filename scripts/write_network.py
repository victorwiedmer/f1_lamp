#!/usr/bin/env python3
"""Write F1NetWork.cpp using only WiFiClient (no IDF HTTP/WS client libs)."""
import textwrap, os
...
dest = r'C:\Users\Victor\source\repos\f1-lamp\wled\usermods\F1LampUsermod\F1NetWork.cpp'
src  = r'C:\Users\Victor\source\repos\f1-lamp\usermod\F1NetWork.cpp'
